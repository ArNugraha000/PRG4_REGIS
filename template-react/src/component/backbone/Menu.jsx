...
const arrMenuCustomer = [
  { head: "Logout", headkey: "logout", link: "/logout", sub: [] },
  { head: "Beranda", headkey: "beranda", link: "/pedoman", sub: [] },
  {
    head: "Registrasi Customer",
    headkey: 1,
    link: "#",
    sub: [
      {
...
if (user && user.role) {
  ...
  if (user.role === "AdminDAKAP" || user.role === "AdminMarketing") {
    menuToDisplay = arrMenu;
  } else if (user.role === "Customer") {
    menuToDisplay = arrMenuCustomer;
  } else {
    menuToDisplay = arrMenuContributor;
  }
} else {
  menuToDisplay = arrMenuContributor;
}
