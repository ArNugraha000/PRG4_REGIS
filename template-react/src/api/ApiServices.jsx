...
// const fetchData = async (endpoint, options = {}, type = "array") => {
//   try {
//     // Cek login khusus untuk username dan password tertentu
//     if (
//       endpoint === "Login" &&
//       options.params?.username === "ages" &&
//       options.params?.password === "ages123"
//     ) {
//       const mockResponse = [
//         {
//           usr_username: "ages",
//           usr_role: options.params.role || "Admin",
//           nama: "Ages User",
//         },
//       ];
//       return type === "non-array" ? mockResponse[0] : mockResponse;
//     }
